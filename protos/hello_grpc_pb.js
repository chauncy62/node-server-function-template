...
var _hello_pb = require('./hello_pb.js');

function serialize_hello_HelloReply(arg) {
  if (!(arg instanceof _hello_pb.HelloReply)) {
...
function deserialize_hello_HelloReply(buffer_arg) {
  return _hello_pb.HelloReply.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_hello_HelloRequest(arg) {
  if (!(arg instanceof _hello_pb.HelloRequest)) {
...
function deserialize_hello_HelloRequest(buffer_arg) {
  return _hello_pb.HelloRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var HelloYeahService = exports.HelloYeahService = {
  sayHello: {
    ...
    requestType: _hello_pb.HelloRequest,
    responseType: _hello_pb.HelloReply,
